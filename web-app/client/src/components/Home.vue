<template>
  <div class="posts">
    <h1>Drugs BlockChain Network</h1>
    <h3>If you are a registered Manufacturer, enter your voterId below</h3>
    ...
    <form v-on:submit="registerManufacturer">
      <input type="text" v-model="registerData.voterId" placeholder="Enter UserName">
      <br>
...
export default {
  ...
  methods: {
    async registerManufacturer() {
      ...
      const apiResponse = await PostsService.registerManufacturer(
